...
function initsToAssigns(inits, t) {
  ...
  n.lineno = vdecl.lineno || t.lineno;
...
(function() {
  ...
  override(NUMBER, function(n, fr) {
    try {
      return new Ans(ANUM, fr);
    }
    catch (e) {
      foobar(e, 3);
    }
...
var foo = true;
function foobar(e, num) {
  if (!(e instanceof StackCleaner)) {
    if (foo) {
      //console.trace();
      var n = arguments[2];
      print(num + " " + n.lineno + n);
      foo = false;
    }
  }
  throw e;
