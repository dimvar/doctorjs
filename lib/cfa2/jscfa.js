...
(function() {
  ...
  labelAST_override(DOT, labelAST_e10s);
  labelAST_override(INDEX, labelAST_e10s);
})();
...
function initDOMObjs() {
  ...
  function aEL(args, withNew, callNode) {
    ...
    if (ec)
      ...
      throw errorWithCode(CFA_ERROR, "Can't create e10sResults entry.");
